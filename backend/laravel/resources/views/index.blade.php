  ...
  <div class='d-flex justify-center mt-2 flex-nowrap align-items-end' style='flex-basis: 30%'>
    <table class='table-sm table-bordered'>
      ...
      <caption style='caption-side: top'><small></small></caption>
        ...
        <tr>
          <td class='bg-dark text-light' style='border-top: 2px solid' nowrap><input type='radio' id='r125' name='period' value="125">half-year</td>
        </tr>
        <tr>
          <td class='bg-dark text-light' style='border-top: 2px solid' nowrap><input type='radio' id='r250' name='period' value="250" checked="checked">year</td>
        </tr>
        <tr>
        ...
        <div class="toast-body">
          <div class='d-flex justify-content-around'>
            <span class='border border-primary rounded p-1'>Range
              ...
              <label><input type='radio' id='r125' name='period' value="125">half-year</label>
              <label><input type='radio' id='r250' name='period' value="250" checked="checked">year</label>
            ...
            <div class='border border-primary rounded p-1'>
              ...
              <input type="number" id="correlation-input" value='20' min="5" max='5000' class='ml-2' size='4' step="50">
            </div>
          </div>
        </div>
      </div>
